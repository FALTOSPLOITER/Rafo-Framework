...
class TestConf:
    def test_api_keys_not_hardcoded(self):
        ...
        assert 'Q4wtGdNmqnaQ267zzUb2rQztDRayEISI' not in source, 'Shodan API key still hardcoded in conf.py'
        assert '8d53c2357c2a13' not in source, 'IPInfo API key still hardcoded in conf.py'
